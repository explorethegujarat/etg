...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Explore The Gujarat — Luxury Gujarat Tour Packages, Gir Safari & More" },
      { name: "description", content: "Premium Gujarat tour packages, Gir jungle safari booking, hotels, cabs and customized itineraries by trusted local experts." },
      { name: "author", content: "Explore The Gujarat" },
